...
excerpt: "A perfect example of limited memory artificial intelligence is self-driving cars. The model examines the speed and direction of other cars in the present moment to make the best decisions on the road."
...
related:
  - title: "How can we build human values into AI?"
    excerpt: "As artificial intelligence (AI) becomes more powerful and more deeply integrated into our lives, the questions of how it is used and deployed are all the more important. What values guide AI? Whose values are they? And how are they selected?"
    publishedDateTime: 2023-04-24T00:00:00Z
    webUrl: "https://www.deepmind.com/blog/how-can-we-build-human-values-into-ai"
    type: article
    provider:
      name: DeepMind
      domain: deepmind.com
